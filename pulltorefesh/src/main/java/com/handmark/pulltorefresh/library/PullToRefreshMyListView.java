...
public class PullToRefreshMyListView extends PullToRefreshAdapterViewBase<MyListView> {
    ...
    public PullToRefreshMyListView(Context context, Mode mode, AnimationStyle style) {
    ...
    protected MyListView createListView(Context context, AttributeSet attrs) {
        final MyListView lv;
        lv = new InternalMyListView(context, attrs);
        return lv;
    }
    ...
    protected class InternalMyListView extends MyListView implements EmptyViewMethodAccessor {

        private boolean mAddedLvFooter = false;

        public InternalMyListView(Context context, AttributeSet attrs) {
            super(context, attrs);
        }
