...
public class SecurityGuaranteeActivity extends AutoBackBtnActivity {

    private static final String CLIENT_TYPE = "AQBZ";

    WebView webView;

    String path = "loan/protocol/security.html";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addTopTitle(R.string.security_guarantee);
